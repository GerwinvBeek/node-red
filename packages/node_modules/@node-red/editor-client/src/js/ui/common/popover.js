 ...
 *    - height : number - height of popover, default 'auto'
 *    - maxHeight : number - max height of popover, default 'auto'
...
RED.popover = (function() {
    ...
    function createPopover(options) {
        ...
        var deleteOnClose = options.deleteOnClose;
        if (!deltaSizes[size]) {
        ...
        var openPopup = function(instant) {
            if (active) {
                ...
                movePopup({target,direction,width,maxWidth,height,maxHeight});
        ...
        var closePopup = function(instant) {
            ...
            if (!active) {
                ...
                if (deleteOnClose){
                    ...
                    target.off('mouseleave disabled');
                }
            }
        }
